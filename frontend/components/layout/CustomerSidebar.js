...
import { ChevronsLeft, ChevronsRight, X, LogOut } from 'lucide-react';
    ...
    <div className="flex h-dvh max-h-dvh flex-col overflow-hidden">
      ...
      <div className="shrink-0 border-t border-white/10 px-3 py-2.5">
        <button
          ...
          className={`
            group relative flex w-full items-center gap-3 rounded-xl px-3 py-2 text-sm font-medium text-white/90
        ...
        >
          <LogOut size={18} strokeWidth={2} className="shrink-0 text-white/75 group-hover:text-white" />
