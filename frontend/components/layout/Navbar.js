    ...
    <header className="sticky top-0 z-40 border-b border-border/80 glass">
      <div className="flex h-[72px] items-center justify-between gap-4 px-4 sm:px-6">
        ...
        <div className="relative" ref={menuRef}>
          ...
          >
            <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-accent to-[var(--color-accent-hover)] text-xs font-semibold text-white">
              {getInitials(user)}
            </span>
                ...
                <div className="p-1.5">
                  <button
                    ...
                    onClick={() => {
                      setMenuOpen(false);
                      notify.info(
                        'Profile management ships with the Settings phase'
                      );
                    }}
                  >
                    <UserRound size={16} />
